...
[데모 영상 1분](https://youtu.be/XnbVtPsR3V8) · [배포된 앱](https://pitchiq-dlpitcher.streamlit.app/) · [트러블슈팅 38건](docs/TROUBLESHOOTING.md) · [설계 결정 기록](docs/ADR.md)
...
| 문서 | 내용 |
|---|---|
| [`docs/TROUBLESHOOTING.md`](docs/TROUBLESHOOTING.md) | 해결 기록 38건. 증상 / 재현 조건 / 표면·근본 원인 / 시도했지만 안 된 것 / 해결 / 검증 |
